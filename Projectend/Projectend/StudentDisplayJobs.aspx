<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterStudent.Master" CodeFile="StudentDisplayJobs.aspx.vb" Inherits="StudentDisplayJobs" %>
...
&nbsp;&nbsp;&nbsp;<asp:Label class="txt2" ID="Label1" runat="server" Text="Label"></asp:Label>
          ...
          <%--  <div class="menu-container">--%>
            ...
            <asp:Label ID="Label7" runat="server" Text="Label"></asp:Label>
                <br />
                <br />
                 <asp:ImageButton src="Img/delete.png" ID="Button1" runat="server" style="width: 42px; height: 42px; border: 0;" />
                <br />
