...
Public Class CompanyViewJobs
    ...
    Protected Sub loadgrid()
        ...
        strSQL = "SELECT * from data_postjobs where user_id = '" & Session("userid") & "'"
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Response.Redirect("CompanyEditAnnounceJobs.aspx")
    End Sub
    Protected Sub BuildNoRecord(ByVal ds As DataSet, ByVal GridView1 As GridView)
        Try
            If ds.Tables(0).Rows.Count = 0 Then
                ...
                GridView1.Rows(0).Cells(0).Text = "ไม่มีงานที่ลงทะเบียนไว้"
