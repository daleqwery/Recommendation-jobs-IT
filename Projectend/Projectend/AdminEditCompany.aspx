<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterAdmin.Master" CodeFile="AdminEditCompany.aspx.vb" Inherits="AdminEditCompany" %>
     ...
     <div class="container-login100">
        <div class="wrap-login100">
            ...
            <div class="login100-form-title">
                <h1 class="auto-style1">แก้ไขข้อมูลบริษัท</h1>
                ...
                <div class="input101">
                    <asp:textbox class="input100" type="text" id="password" runat="server" maxlength="18"></asp:textbox>
                </div>
                <div class="input101">
               ...
               &nbsp;&nbsp;<asp:Button class="login100-form-btn" ID="Button2" runat="server" height="44px" Text="ลบข้อมูล" />
                </div>
