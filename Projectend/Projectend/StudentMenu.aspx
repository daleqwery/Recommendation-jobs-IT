<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterStudent.Master" CodeFile="StudentMenu.aspx.vb" Inherits="StudentMenu" %>
                    ...
                    <div class="cards-list">
                        ...
                        <div class="card 1">
                            <div class="card_image">
                                <asp:imagebutton class="card_image" src="Img/model1.jpg" id="ImageButton1" runat="server" />
                        ...
                        <div class="card 2">
                            <div class="card_image">
                                <asp:imagebutton class="card_image" src="Img/findjob.jpg" id="ImageButton2" runat="server" />
                            </div>
                            <div class="card_title title-white">
