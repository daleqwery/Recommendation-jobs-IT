...
Public Class CompanyEditAnnounceJobs
    ...
    'Protected ReadOnly Property MyProperty As String
    '    Get
    '        Return "your value"
    '    End Get
    'End Property
    ...
    Protected Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Conn.Open()
        ' Dim cn As String = "select ID_Company from RegisterCompany WHERE UserName = '" & Session("NAME") & "'"
        Dim sqlb As String = "UPDATE data_postjobs set Status = '" + updatestatus + "'" + "WHERE Job_id = '" + Session("Jobid") + "'"
