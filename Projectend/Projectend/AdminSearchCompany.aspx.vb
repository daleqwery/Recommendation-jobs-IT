...
Public Class AdminSearchCompany
    ...
    Protected Sub loadgrid()
        ...
        strSQL = "SELECT * from [data_user] where usertype_id = '" & "UT002" & "'"
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Session("edituserid") = GridView1.SelectedRow.Cells(0).Text
        ...
        Response.Redirect("AdminEditCompany.aspx")
    ...
    Protected Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        sql2 = "SELECT * from [data_user] where username LIKE '%" & TextBox12.Text & "%' or firstname LIKE '%" & TextBox12.Text & "%'  ORDER BY username DESC"
